...
const JOINT_PREP = [
  'ישיבה ונשימה | 2 דקות',
  'Cat-Cow | 10 חזרות',
  'סיבובי כתף ופרק כף יד | 10 לכל כיוון',
  'כלב מביט מטה, כיפוף ברכיים לסירוגין | 60 שניות',
];

const SUN_A = [
  'Tadasana | הר, 3 נשימות',
  'Urdhva Hastasana | הושטה מעלה',
  'Uttanasana | כיפוף קדימה',
  'Ardha Uttanasana | חצי הרמה',
  'Chaturanga | הנמכה מבוקרת',
  'Urdhva Mukha Svanasana | כלב מביט מעלה',
  'Adho Mukha Svanasana | כלב מביט מטה, 5 נשימות',
];
...
export const YOGA_WORKOUTS: LibraryWorkout[] = [
  {
    ...
    structure: [
      { label: 'ברכת שמש א׳', detail: '5 סבבים', items: SUN_A },
      {
        ...
        items: [
          'Virabhadrasana I | לוחם א׳',
          'Virabhadrasana II | לוחם ב׳',
          'Utthita Trikonasana | משולש',
          'Parsvakonasana | זווית צידית',
        ],
      },
      {
        label: 'סיום',
        items: [
          'Malasana | כריעה עמוקה, 60 שניות',
          'Paschimottanasana | כיפוף קדימה בישיבה, 90 שניות',
          'Supta Matsyendrasana | פיתול בשכיבה, 60 שניות לכל צד',
        ],
      },
    ],
    cooldown: ['Savasana | שכיבת מנוחה, 4 דקות'],
    scaling: scale(
      '3 ברכות שמש, ברכיים על המזרן ב-Chaturanga.',
      'לפי הפרוטוקול.',
      '8 ברכות שמש וקצב רציף.',
    ),
  ...
  },
  {
    ...
    structure: [
      { label: 'חימום זורם', detail: '5 סבבים', items: SUN_A },
      {
        ...
        items: [
          'Virabhadrasana I | לוחם א׳',
          'Virabhadrasana III | לוחם ג׳',
          'Ardha Chandrasana | חצי ירח',
          'Parivrtta Trikonasana | משולש מסובב',
          'Utkatasana | כיסא',
        ],
      },
      {
      ...
      },
      {
        label: 'רצפה',
        items: [
          'Bhujangasana | קוברה, 5 נשימות',
          'Dhanurasana | קשת, 3 סבבים של 5 נשימות',
          'Setu Bandha | גשר, 60 שניות',
          'Halasana | מחרשה, 60 שניות',
        ],
      },
    ],
    cooldown: ['Supta Matsyendrasana | פיתול, 90 שניות לכל צד', 'Savasana | 5 דקות'],
    scaling: scale(
      'רצף עמידה אחד לכל צד, דילוג על חצי ירח ומחרשה.',
      'לפי הפרוטוקול.',
      'תוספת של עמידת ידיים בקיר ו-Chaturanga מלא בכל מעבר.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      { label: 'חימום', detail: '5 סבבים בקצב', items: SUN_A },
      {
        ...
        items: [
          'Utkatasana | כיסא',
          'Virabhadrasana III | לוחם ג׳',
          'Chaturanga Hold | אחזקה נמוכה, 20 שניות',
          'Phalakasana | פלאנק, 45 שניות',
          'Vasisthasana | פלאנק צד, 30 שניות',
        ],
      },
      {
        label: 'שיאים',
        ...
        items: [
          'Bakasana | עורב',
          'Adho Mukha Vrksasana | עמידת ידיים בקיר, 30 שניות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips, 'Savasana | 3 דקות'],
    scaling: scale(
      'ברכיים ב-Chaturanga, דילוג על העורב.',
      'לפי הפרוטוקול, עורב עם מדרגה.',
      'לפי הפרוטוקול, אחזקות ארוכות יותר.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      { label: 'חימום', detail: '4 סבבים', items: SUN_A },
      {
        ...
        items: [
          'Phalakasana | פלאנק, 45 שניות',
          'Vasisthasana | פלאנק צד, 30 שניות לכל צד',
          'Navasana | סירה, 45 שניות',
          'Ardha Navasana | חצי סירה, 30 שניות',
          'Knee-to-Nose מכלב מביט מטה | 10 לכל צד',
        ],
      },
      {
        label: 'איזון',
    ...
    scaling: scale(
      'פלאנק מהברכיים, סירה עם ברכיים כפופות.',
      'לפי הפרוטוקול.',
      '4 סבבים ואחזקות של דקה.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          ...
          'Pigeon | יונה, לכל צד',
          'Frog | צפרדע',
          'Sleeping Swan | ברבור ישן, לכל צד',
          'Supported Bridge | גשר נתמך',
        ],
      },
    ],
    cooldown: ['רגליים על הקיר | 4 דקות', 'Savasana | 5 דקות'],
    scaling: scale(
      '2 דקות בכל תנוחה עם תמיכת כריות.',
      '3 דקות בכל תנוחה.',
      '5 דקות בכל תנוחה.',
    ),
    scoreType: 'completion',
    ...
    structure: [
      {
        ...
        items: [
          ...
          'Sphinx | ספינקס',
          'Seal | כלב ים',
          'Melting Heart | לב נמס',
          'Supine Twist | פיתול בשכיבה, לכל צד',
          'Child’s Pose | תנוחת ילד',
        ],
      },
    ],
    cooldown: ['Savasana | 5 דקות'],
    scaling: scale(
      '2 דקות בכל תנוחה, תמיכת כריות מלאה.',
      '3 דקות בכל תנוחה.',
      '4-5 דקות בכל תנוחה.',
    ),
    scoreType: 'completion',
    ...
    structure: [
      {
        label: '3 סבבים',
        items: [
          '90/90 Hip Switch | 10 חזרות',
          'Cossack Squat | 8 לכל צד',
          'Deep Squat Hold | 60 שניות',
          'Couch Stretch | 90 שניות לכל צד',
          'Active Pigeon Lift | 8 לכל צד',
        ],
      },
    ],
  ...
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          ...
          'Thoracic Extension על גליל | 60 שניות',
          'Band Dislocates | 10 חזרות איטיות',
          'Wall Slides | 12 חזרות',
    ...
    scaling: scale(
      'גומייה רחבה, טווח קטן.',
      'לפי הפרוטוקול.',
      'גומייה צרה וטווח מלא.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: '3 סבבים',
        items: [
          'Knee-to-Wall | 15 חזרות לכל צד',
          'Deep Squat Hold עם עקבים על הרצפה | 60 שניות',
          'Calf Raise איטי | 15 חזרות',
          'Tibialis Raise | 15 חזרות',
          'Toe Splay ו-Short Foot | 10 חזרות',
        ],
      },
    ],
    cooldown: ['מתיחת שוקיים בקיר | 90 שניות לכל צד', 'ישיבה על העקבים | 60 שניות'],
    scaling: scale(
      'עקבים על צלחת, טווח קטן.',
      'לפי הפרוטוקול.',
      'טווח מלא עם עומס קל.',
    ),
    scoreType: 'completion',
    ...
    structure: [
      {
        ...
        items: [
          'Low Lunge | לאנג׳ נמוך, לכל צד',
          'Half Split | חצי שפגט, לכל צד',
          'Pigeon | יונה, לכל צד',
          'Figure Four בשכיבה | לכל צד',
          'Legs up the Wall | רגליים על הקיר, 3 דקות',
          'Supine Twist | פיתול, לכל צד',
        ],
      },
    ],
    cooldown: ['Savasana | 4 דקות'],
    scaling: scale(
      'תמיכת כריות בכל תנוחה.',
      'לפי הפרוטוקול.',
      'אחזקות של 2 דקות.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'נשימת סרעפת | יד על הבטן',
          'נשימת קופסה | 4-4-4-4',
          'נשימה 4-7-8 | נשיפה ארוכה',
          'Nadi Shodhana | נשימה מתחלפת',
        ],
      },
      {
        label: 'תנוחות תמיכה',
    ...
    cooldown: ['Savasana | 5 דקות'],
    scaling: scale(
      'רק נשימת סרעפת ונשימת קופסה.',
      'לפי הפרוטוקול.',
      'תוספת של 5 דקות ישיבה שקטה.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ardha Chandrasana | חצי ירח',
          'Natarajasana | רקדן',
          'Utthita Hasta Padangusthasana | אחיזת בוהן בעמידה',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips, 'Savasana | 3 דקות'],
    scaling: scale(
      'יד על הקיר, כף רגל על השוק ולא על הירך.',
      'לפי הפרוטוקול.',
      'עיניים עצומות בתנוחות הבסיס.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    scaling: scale(
      'ספינקס וקוברה בלבד.',
      'עד גמל עם ידיים על האגן.',
      'כולל Urdhva Dhanurasana לגלגל מלא.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Ardha Matsyendrasana | חצי מלך הדגים',
          'Parivrtta Utkatasana | כיסא מסובב',
          'Parivrtta Trikonasana | משולש מסובב',
          'Thread the Needle | חוט המחט',
          'Supta Matsyendrasana | פיתול בשכיבה',
        ],
      },
    ],
    cooldown: ['Balasana | 2 דקות', 'Savasana | 3 דקות'],
    scaling: scale(
      'טווח קטן, יד על הרצפה לתמיכה.',
      'לפי הפרוטוקול.',
  ...
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Low Lunge | כופפי ירך',
          'Half Split | מיתרי ברך',
          'Downward Dog עם כיפוף ברכיים לסירוגין | שוקיים',
          'Figure Four | ישבן',
        ],
      },
      {
        ...
        items: [
          ...
          'Single Leg Balance | 45 שניות לכל צד',
          'Calf Raise | 20 חזרות',
        ],
      },
    ],
    ...
    scaling: scale(
      'תמיכת כריות, 60 שניות בכל תנוחה.',
      'לפי הפרוטוקול.',
      '2 דקות בכל תנוחה, 3 סבבי חיזוק.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Supported Child’s Pose | תנוחת ילד נתמכת',
          'Supported Bridge | גשר נתמך',
          'Reclined Butterfly | פרפר בשכיבה',
          'Supported Twist | פיתול נתמך, לכל צד',
          'Legs up the Wall | רגליים על הקיר',
        ],
      },
    ],
