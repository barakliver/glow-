...
const MAT_PREP = [
  'נשימה צידית בשכיבה | 10 נשימות, יד על הצלעות', 'הטיית אגן | 10 חזרות', 'Cat-Cow | 8 חזרות', 'גשר ירך איטי | 10 חזרות', 'מתיחת ברך לחזה לסירוגין | 8 לכל צד',
];

const STANDING_PREP = [
  'הליכה במקום | 2 דקות', 'גלגול עמוד שדרה מעמידה | 5 חזרות איטיות', 'סיבובי כתף | 10 לכל כיוון', 'הטיית אגן בעמידה | 10 חזרות',
];
    ...
    structure: [
      {
        ...
        items: [
          'The Hundred | 100 פעימות, 10 נשימות', 'Roll Up | 6 חזרות', 'Roll Over | 5 חזרות', 'Single Leg Circles | 5 לכל כיוון, לכל רגל',
        ],
      },
      {
        label: 'הרצף המרכזי',
        items: [
          'Rolling Like a Ball | 8 חזרות', 'Single Leg Stretch | 10 לכל צד', 'Double Leg Stretch | 10 חזרות', 'Scissors | 10 לכל צד', 'Lower Lift | 8 חזרות', 'Criss Cross | 10 לכל צד',
        ],
      },
      {
        label: 'עמוד שדרה וירך',
        items: [
          'Spine Stretch Forward | 5 חזרות', 'Open Leg Rocker | 6 חזרות', 'Corkscrew | 4 לכל כיוון', 'Saw | 6 לכל צד',
        ],
      },
      {
        label: 'שרשרת אחורית וסיום',
        items: [
          'Swan Dive | 6 חזרות', 'Single Leg Kick | 8 לכל צד', 'Double Leg Kick | 6 חזרות', 'Neck Pull | 6 חזרות', 'Side Kick Series | 10 מכל תרגיל, לכל צד', 'Teaser | 3 חזרות', 'Seal | 8 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'ברכיים כפופות ב-Roll Up ו-Teaser, דילוג על Roll Over ו-Open Leg Rocker.', 'הרצף המלא עם ידיים מאחורי הירך בתרגילים הקשים.', 'הרצף המלא בקצב רציף בלי הפסקות בין תרגילים.',
    ),
    ...
    structure: [
      {
        ...
        items: [
          'אגן ניטרלי ונשימה | 10 נשימות', 'הטיית אגן | 10 חזרות', 'Toe Taps | 10 לכל צד',
        ],
      },
      {
        label: 'ליבה',
        detail: '2 סבבים',
        items: [
          'Dead Bug | 8 לכל צד', 'Single Leg Stretch | 8 לכל צד', 'The Hundred | 50 פעימות', 'Bridge | 10 חזרות',
        ],
      },
      {
        label: 'גב',
        items: [
          'Swimming | 30 שניות', 'Bird Dog | 8 לכל צד', 'Child’s Pose | 60 שניות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.breath],
    scaling: scale(
      'ראש על המזרן בכל התרגילים בשכיבה.', 'הרמת ראש וכתפיים לפי הפרוטוקול.', 'רגליים ישרות וזווית נמוכה יותר.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Teaser | 5 חזרות', 'Single Leg Bridge | 10 לכל צד', 'Side Plank with Leg Lift | 10 לכל צד', 'Band Pull-aparts | 15 חזרות', 'Swan with Arm Reach | 8 חזרות', 'Roll Up עם משקולת קלה | 8 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.posterior],
    scaling: scale(
      'בלי התנגדות, 2 סבבים.', 'גומייה קלה, 3 סבבים.', 'גומייה חזקה ו.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Dead Bug | 10 לכל צד, איטי', 'Bird Dog | 10 לכל צד', 'Side Plank | 30 שניות לכל צד', 'Hollow Hold | 30 שניות', 'Glute Bridge March | 10 לכל צד',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'פלאנק צד מהברכיים, 20 שניות.', 'לפי הפרוטוקול.', 'פלאנק צד עם הרמת רגל, 45 שניות.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: 'פתיחה',
        items: [
          'פתיחת חזה במשקוף | 45 שניות', 'מתיחת כופפי ירך בכריעה | 60 שניות לכל צד', 'Thread the Needle | 45 שניות לכל צד',
        ],
      },
      {
        label: 'חיזוק',
        detail: '3 סבבים',
        items: [
          'Band Pull-aparts | 15 חזרות', 'Prone Y-T-W | 8 מכל אות', 'Glute Bridge | 15 חזרות', 'Wall Angels | 10 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.shoulders],
    scaling: scale(
      '2 סבבים, בלי גומייה.', 'לפי הפרוטוקול.', '4 סבבים עם גומייה חזקה.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: '3 סבבים',
        items: [
          'Single Leg Bridge | 12 לכל צד', 'Swimming | 45 שניות', 'Prone Leg Lifts | 12 לכל צד', 'Clamshells עם גומייה | 15 לכל צד', 'Hamstring Curl בגלגול | 12 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.posterior],
    scaling: scale(
      'גשר דו-רגלי, בלי גומייה.', 'לפי הפרוטוקול.', 'גשר על רגל אחת עם משקל, 4 סבבים.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Spine Stretch Forward | 8 חזרות איטיות', 'Saw | 8 לכל צד', 'מתיחת מיתרי ברך עם גומייה | 90 שניות לכל צד', 'Figure Four | 90 שניות לכל צד', 'Spinal Twist בשכיבה | 90 שניות לכל צד', 'Mermaid | 60 שניות לכל צד', 'Child’s Pose | 2 דקות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'טווח חלקי, ברכיים כפופות.', 'לפי הפרוטוקול.', 'טווח מלא, אחזקות של 2 דקות.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'The Hundred | 100 פעימות', 'Single Leg Stretch | 15 לכל צד', 'Double Leg Stretch | 12 חזרות', 'Criss Cross | 15 לכל צד', 'Lower Lift | 10 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.breath],
    scaling: scale(
      'ראש על המזרן, ברכיים ב-90 מעלות.', 'לפי הפרוטוקול.', 'רגליים ישרות ונמוכות, 4 סבבים.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: '3 סבבים',
        items: [
          'עמידה על רגל אחת | 45 שניות לכל צד', 'Standing Leg Circles | 10 לכל כיוון, לכל רגל', 'Roll Down | 6 חזרות', 'Standing Side Bend | 10 לכל צד', 'Heel Raises | 20 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'יד על הקיר לתמיכה לאורך כל התרגילים.', 'בלי תמיכה, עיניים פקוחות.', 'עיניים עצומות בעמידה על רגל אחת.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    warmup: [
      'נשימה בשכיבה עם ברכיים כפופות | 10 נשימות', 'הטיית אגן | 12 חזרות', 'ברך לחזה לסירוגין | 10 לכל צד',
    ],
    structure: [
      {
        label: 'רצף עדין',
        ...
        items: [
          'Cat-Cow | 10 חזרות', 'Bird Dog | 8 לכל צד', 'Glute Bridge | 12 חזרות', 'Dead Bug | 8 לכל צד', 'Side Plank מהברכיים | 20 שניות לכל צד', 'Knee Rolls | 10 לכל צד',
        ],
      },
    ],
    cooldown: [
      'תנוחת ילד | 2 דקות', 'שכיבה עם רגליים על כיסא | 3 דקות', 'נשימת סרעפת | 2 דקות',
    ],
    scaling: scale(
      'טווח קטן, 6 חזרות בכל תרגיל.', 'לפי הפרוטוקול.', 'תוספת של Swimming ו-Prone Leg Lifts.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Side Kick Front-Back | 15 חזרות', 'Side Kick Up-Down | 15 חזרות', 'Small Circles | 15 לכל כיוון', 'Clamshell | 20 חזרות', 'Inner Thigh Lift | 15 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'סבב אחד לכל צד, בלי גומייה.', 'לפי הפרוטוקול.', 'גומייה חזקה, 3 סבבים.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'The Hundred | 50 פעימות', 'Roll Up | 5 חזרות', 'Single Leg Stretch | 10 לכל צד', 'Bridge | 12 חזרות', 'Swimming | 30 שניות', 'Side Plank | 20 שניות לכל צד', 'Spine Stretch Forward | 5 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.breath],
    scaling: scale(
      'סבב אחד, בקצב נוח.', '2 סבבים ברצף בלי מנוחה בין תרגילים.', '3 סבבים ברצף.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      ...
      },
      {
        label: 'שלב 2 - חלקים',
        items: [
          'Teaser עם רגל אחת | 6 לכל צד', 'Teaser עם ברכיים כפופות | 6 חזרות', 'Half Teaser מהרצפה | 8 חזרות',
        ],
      },
      {
        label: 'שלב 3 - התרגיל',
    ...
    cooldown: [...COOLDOWNS.posterior],
    scaling: scale(
      'עצירה בשלב 2, ידיים על הירך.', 'Teaser עם ברכיים כפופות.', 'Teaser מלא, רגליים ישרות.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'נשימה צידית בשכיבה | ידיים על הצלעות', 'נשימה צידית עם גומייה סביב הצלעות', 'נשימה בישיבה מזרחית', 'נשימה בתנוחת ילד',
        ],
      },
      {
        label: 'יישום',
        ...
        items: [
          'Bridge | 10 חזרות', 'Dead Bug | 8 לכל צד', 'Cat-Cow | 10 חזרות', 'The Hundred | 100 פעימות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.breath],
    scaling: scale(
      'רק חלק הלימוד.', 'לפי הפרוטוקול.', 'תוספת של אחזקות ארוכות בנשיפה.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: '3 סבבים',
        items: [
          'Prone Y-T-W | 8 מכל אות', 'Side Plank with Rotation | 10 לכל צד', 'Single Leg Bridge | 12 לכל צד', 'Clamshell עם גומייה | 20 לכל צד', 'Bird Dog | 10 לכל צד',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.shoulders],
    ...
    structure: [
      {
        ...
        items: [
          'Cat-Cow | 10 חזרות', 'Bird Dog | 10 לכל צד', 'Side-Lying Leg Series | 12 מכל תרגיל, לכל צד', 'Glute Bridge | 15 חזרות', 'Wall Squat Hold | 30 שניות, 3 סבבים', 'Standing Roll Down | 6 חזרות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'טווח קטן, תמיכה ביד.', 'לפי הפרוטוקול.', 'תוספת גומייה בכל תרגיל.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    cooldown: [...COOLDOWNS.posterior],
    scaling: scale(
      'טווח חלקי, ברכיים כפופות בישיבה.', 'לפי הפרוטוקול.', 'טווח מלא, אחזקה של 3 שניות בקצה.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        detail: ', קצב איטי',
        items: [
          'Arm Circles | 20 לכל כיוון', 'Front Raise | 15 חזרות', 'Lateral Raise | 15 חזרות', 'Band Pull-aparts | 20 חזרות', 'Tricep Extension | 15 חזרות', 'Prone Y-T-W | 8 מכל אות',
        ],
      },
    ],
    cooldown: [...COOLDOWNS.shoulders],
    scaling: scale(
      'בלי משקל. הקצב האיטי הוא העבודה.', 'משקולות קלות מאוד, 3 סבבים.', 'משקולות קלות, 4 סבבים בקצב איטי יותר.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        ...
        items: [
          'Cat-Cow | 10 חזרות איטיות', 'Thread the Needle | 60 שניות לכל צד', 'Child’s Pose | 90 שניות', 'Knee Rolls | 10 לכל צד', 'Figure Four | 90 שניות לכל צד', 'רגליים על הקיר | 3 דקות',
        ],
      },
    ],
    cooldown: ['נשימה 4-7-8 | 8 סבבים', 'שכיבה שקטה | 2 דקות'],
    scaling: scale(
      'אחזקות של 45 שניות.', 'לפי הפרוטוקול.', 'אחזקות של 2 דקות.',
    ),
    scoreType: 'completion',
  },
  {
    ...
    structure: [
      {
        label: 'ליבה',
        items: [
          'The Hundred | 100 פעימות', 'Roll Up | 8 חזרות', 'Single Leg Circles | 8 לכל כיוון', 'Rolling Like a Ball | 10 חזרות',
        ],
      },
      {
        label: 'סדרת הבטן',
        items: [
          'Single Leg Stretch | 12 לכל צד', 'Double Leg Stretch | 12 חזרות', 'Scissors | 12 לכל צד', 'Lower Lift | 10 חזרות', 'Criss Cross | 12 לכל צד',
        ],
      },
      {
        label: 'צד וגב',
        items: [
          'Side Kick Series | 12 מכל תרגיל, לכל צד', 'Swan | 8 חזרות', 'Swimming | 60 שניות', 'Single Leg Kick | 10 לכל צד',
        ],
      },
      {
        label: 'סיום',
    ...
    cooldown: [...COOLDOWNS.hips],
    scaling: scale(
      'חצי מהחזרות, דילוג על Teaser.', 'לפי הפרוטוקול.', 'לפי הפרוטוקול ברצף בלי מנוחות.',
    ),
    scoreType: 'completion',
  },
];
